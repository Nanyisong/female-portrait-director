...
女性ポートレート・プロンプトディレクター Skill は、AI 画像生成向けの構造化プロンプト生成・視覚ディレクションシステムです。V1.4 では、単一のスタイルレジストリから必要なルートだけを読み込み、明示されたパラメータを固定し、一つの自然な撮影瞬間へ統合します。
...
- 作者：Li Yue（李岳）
- バージョン：`FEMALE-PORTRAIT-DIRECTOR-V1.4`
