...
女性人像提示词导演 Skill 是一个面向 AI 生图场景的结构化女性人像提示词生成与视觉导演系统。V1.4 会通过唯一风格注册表按需加载单一路由，锁定明确参数，完成视觉推导，再将年龄特征、五官、身形、姿态、服装、场景、镜头、光线和滤镜融合为同一个自然摄影瞬间。
...
- 作者：李岳
- 版本：`FEMALE-PORTRAIT-DIRECTOR-V1.4`
