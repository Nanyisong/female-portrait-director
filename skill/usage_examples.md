...
下面是部分内置风格的简短调用入口。V2.0-MODULAR 会通过风格注册表按需加载单一路由，锁定参数，完整扩写年龄、五官、身形、服装、姿态、场景、镜头、光线和滤镜，再将这些模块融合为摄影导演式提示词。当前已实现 14 条 Route，完整列表见 [style-registry.md](style-registry.md)，详细示例位于 `examples/`。
